...
\epsilon_{m}^{\prime} &=1.15 \left[1+\frac{\rho_{b}}{\rho_{s}}\left(\epsilon_{s}^{\alpha}\right)+m_{v}^{\beta^{\prime}} \epsilon_{f w}^{\prime \alpha}-m_{v}\right]^{1 / \alpha} - 0.68\\ 
...
（$0<S<1, 0<C<1$）。$\alpha$是由经验所得的常数，其值为0.65。
\begin{equation} 
	\label{eqn:soil_beta}
	\begin{aligned}
